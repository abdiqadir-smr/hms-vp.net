...
Public Class NurseWardboyRecord
    ...
    Private Sub NurseWardboyRecord_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        NurseWardboy_Details.Show()
        Me.Hide()
    End Sub
